 ...
 *
 * Panduan penggunaan (bobot tertinggi = extrabold; font-black ditiadakan
 * agar hierarchy tegas dan tampilan tidak terasa "berteriak"):
 * - font-extrabold (800)→ H1 hero + H2 section headings (top weight)
 * - font-bold (700)     → H3 card titles, stat numbers, primary/WhatsApp CTA
 * - font-semibold (600) → eyebrow labels, nav items, secondary/outline buttons,
 *                         inline links, badges/chips
 * - font-medium (500)   → body emphasis, secondary info
 *
 * Tracking standar:
 * - Eyebrow uppercase  → tracking-[0.12em]  (bukan 0.16–0.24em)
