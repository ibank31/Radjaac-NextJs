...
export const kebumenAreas = [
    ...
    },
  {
      ...
      localCases: [
        [
          "Ruko & toko pusat kota",
          "AC ruang jualan yang ramai dekat Pasar Gombong; sebagian pemilik menambah unit bertahap.",
        ],
        [
          "Klinik & rumah sakit",
          "AC ruang tunggu dan ruang periksa supaya pasien dan staf nyaman.",
        ],
        [
          "Rumah & bangunan lama",
          "Pengecekan daya listrik dulu, lalu pengiriman unit dan pemasangan ke alamat di Gombong.",
        ],
      ],
      label: "Jual AC Gombong",
      title: "Jual AC Gombong | Ruko Pasar Wonokriyo, Klinik & Bangunan Tua Pusat Kota — Radja AC",
      description: "AC untuk ruko di Pasar Wonokriyo Gombong, ruang tunggu klinik dekat Stasiun Gombong, atau bangunan tua yang perlu cek daya dulu? Radja AC cek PK, stok, dan pengiriman via WhatsApp.",
      ...
      nearbyAreaLinks: [
        [
          "Jual AC Kebumen",
          routes.jualAcKebumen,
        ],
        [
          "Jual AC Banyumas",
          routes.jualAcBanyumas,
        ],
        [
          "Jual AC Purwokerto",
          routes.jualAcPurwokerto,
        ],
        [
          "Jual AC Cilacap",
          routes.jualAcCilacap,
        ],
      ],
      trustBullets: [
      ...
      relatedLinks: [
        ...
        [
          "AC 1/2 PK",
          routes.katalogAcSetengahPk,
        ],
        [
          "AC Low Watt",
          routes.katalogAcLowWatt,
        ],
        [
          "Kalkulator PK AC",
          routes.kalkulatorPkAc,
        ],
        [
          "Kontak Radja AC",
          routes.kontak,
    ...
    },
  {
      ...
      title: "Jual AC Kutowinangun | Sentra Bawang Merah, Pedagang Pasar & Rumah Desa — Radja AC",
      description: "AC untuk toko pedagang bawang merah di Pasar Kutowinangun, rumah desa jalur Kebumen–Prembun, atau usaha lokal? Radja AC cek PK, stok, dan pengiriman via WhatsApp.",
