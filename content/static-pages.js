...
export const staticPageMetadata = {
  home: {
    ...
    description:
      "RADJA AC membantu pembelian AC original multi-brand untuk rumah, kost, toko, kantor, hotel, usaha, dan proyek. Konsultasi PK, cek stok, pengiriman unit, dan opsi pemasangan.",
    path: routes.home,
