...
export const staticPageMetadata = {
  home: {
    title: "Radja AC | AC Original Multi-Brand untuk Rumah, Usaha & Proyek",
    description:
      "Radja AC membantu pembelian AC original multi-brand untuk rumah, kost, toko, kantor, hotel, usaha, dan proyek. Cek PK, stok, pengiriman, dan opsi pemasangan.",
    path: routes.home,
    image: "/photos/showroom/showroom-multibrand-radja-ac-purwokerto-01.webp",
  },

  jualAc: {
    title: "Jual AC Original Multi-Brand | Cek PK & Stok — Radja AC",
    description:
  ...
  katalog: {
    title: "Katalog AC Original | Split, Inverter & Low Watt — Radja AC",
    description:
  ...
  pengadaanAc: {
    title: "Supplier AC Banyak Unit — Proyek, Hotel, Kost & Kantor | Radja AC",
    description:
      "Supplier & distributor AC banyak unit dari gudang Radja AC Sokaraja. Stok ready, kirim bertahap, pasang bergaransi. Harga khusus proyek — minta penawaran.",
    path: routes.pengadaanAc,
  },

  buktiPengirimanProyek: {
    title: "Bukti Pengiriman AC & Proyek | Dokumentasi Radja AC",
    description:
      "Lihat dokumentasi pengiriman AC, stok gudang, showroom, display produk, material instalasi, dan aktivitas pemasangan Radja AC sebagai bukti operasional nyata.",
  ...
  pengirimanPemasangan: {
    ...
    description:
      "Informasi pengiriman unit AC baru, opsi pemasangan, garansi pemasangan 1 bulan, dan bantuan klaim unit. Cek unit, PK, alamat, dan kondisi lokasi sebelum pembelian.",
  ...
  kalkulatorPkAc: {
    title: "Kalkulator PK AC | Estimasi Kebutuhan Ruangan — Radja AC",
    description:
