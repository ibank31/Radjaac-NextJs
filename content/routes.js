...
export const sitemapRoutes = [
  ...
  { path: routes.jualAcWangon, priority: 0.76 },
  { path: routes.jualAcKaranglewas, priority: 0.76 },
  { path: routes.jualAcKembaran, priority: 0.76 },
  { path: routes.jualAcPatikraja, priority: 0.74 },
  { path: routes.jualAcRawalo, priority: 0.74 },
  ...
  { path: routes.jualAcKroya, priority: 0.7 },
  { path: routes.jualAcMajenang, priority: 0.7 },
  { path: routes.jualAcSidareja, priority: 0.7 },
