    ...
    <main id="main-content" className="min-h-screen bg-white text-slate-800">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-14 sm:px-6 lg:grid-cols-[1.04fr_0.96fr] lg:px-8 lg:py-20">
          ...
          <div className="rounded-[1.7rem] border border-blue-100 bg-white p-5 shadow-2xl shadow-blue-900/10">
            <div className="mb-4 flex items-center justify-between gap-4 rounded-2xl bg-blue-950 px-5 py-4 text-white">
              <h2 className={`${typography.sectionTitle}`}>Alur order banyak unit</h2>
        ...
        <div className="mx-auto max-w-7xl px-5 py-14 sm:px-6 lg:px-8">
          <div className="grid gap-5 lg:grid-cols-2">
            <section className="rounded-[1.7rem] border border-slate-200 bg-white p-6 shadow-sm">
              <p className={`${typography.eyebrow} text-red-600`}>Kebutuhan segmen</p>
              <h2 className={`mt-3 ${typography.sectionTitle} text-blue-950`}>Kebutuhan pengadaan</h2>
            ...
            <section className="rounded-[1.7rem] border border-slate-200 bg-white p-6 shadow-sm">
              <p className={`${typography.eyebrow} text-red-600`}>Brief teknis</p>
              <h2 className={`mt-3 ${typography.sectionTitle} text-blue-950`}>Data yang perlu disiapkan</h2>
              <ul className="mt-5 space-y-3 text-sm leading-6 text-slate-700">
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <div>
              <p className={`${typography.eyebrow} text-red-600`}>Stok, kirim & pasang</p>
              <h2 className={`mt-3 ${typography.sectionTitle} text-blue-950`}>
      ...
      <section className="bg-[#F8FAFC]">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-6 lg:px-8">
          <div className="mb-8 max-w-3xl">
            <p className={`${typography.eyebrow} text-red-600`}>Garansi & bantuan klaim</p>
            <h2 className={`mt-3 ${typography.sectionTitle} text-blue-950`}>
      ...
      {faqStructuredData ? (
        <section className="bg-white">
          <div className="mx-auto max-w-7xl px-5 py-16 sm:px-6 lg:px-8">
            <div className="mb-8 max-w-3xl">
              <p className={`${typography.eyebrow} text-red-600`}>FAQ pengadaan</p>
              <h2 className={`mt-3 ${typography.sectionTitle} text-blue-950`}>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {item.faqs.map(([question, answer]) => (
                <div key={question} className="rounded-[1.5rem] border border-slate-200 bg-white p-6 shadow-sm">
                  <h3 className={`${typography.cardTitle} text-blue-950`}>{question}</h3>
      ...
      <section className="bg-[#F8FAFC]">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 mb-6 max-w-3xl">
            <p className={`${typography.eyebrow} text-red-600`}>Segmen pengadaan terkait</p>
            <h3 className={`mt-3 ${typography.cardTitle} text-blue-950`}>
